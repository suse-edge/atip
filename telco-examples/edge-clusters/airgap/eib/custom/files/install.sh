...
stage_local_airgap_tarball() {
    ...
    if [ -f "${INSTALL_RKE2_ARTIFACT_PATH}/rke2-images.${SUFFIX}.tar.zst" ]; then
        ...
        cp -f ${INSTALL_RKE2_ARTIFACT_PATH}/rke2-images*.${SUFFIX}.tar.zst "${INSTALL_RKE2_AGENT_IMAGES_DIR}/"
        ...
        cp -f ${INSTALL_RKE2_ARTIFACT_PATH}/rke2-images*.${SUFFIX}.tar.gz "${INSTALL_RKE2_AGENT_IMAGES_DIR}/"
