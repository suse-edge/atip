# Edge clusters for Telco using aarch64 architecture
...
- `base-images` - To include inside the `SL-Micro.aarch64-6.1-Base-RT-SelfInstall-RC1.raw` image downloaded from the SUSE Customer Center.
