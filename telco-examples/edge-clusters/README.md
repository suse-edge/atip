...
Additional examples cover the use of IPv4 and IPv6, or IPv6 only and can be found here:
- [Single node dual-stack cluster with DHCP/autoconfiguration](./dhcp/dual-stack/single-node/)
- [Single node IPv6 cluster with autoconfiguration](./dhcp/ipv6/single-node/)
