...
- `single-cni`:
    ...
    |:-------------------------------------|:-----------:|:------------:|
    | `cluster-v6-calico.yaml`             |    Calico   |    Calico    |
    | `cluster-v6-canal.yaml`              |    Canal    |     Canal    |
    | `cluster-v6-cilium.yaml`             |    Cilium   |    Cilium    |

- `multus-cni`:
    | Filename                             | Primary CNI | Primary IPAM | Secondary CNI | Secondary IPAM |
    |:-------------------------------------|:-----------:|:------------:|:-------------:|:--------------:|
    | `cluster-v6-calico_hostlocal.yaml`   |    Calico   |    Calico    |      PTP      |   host-local   |
    | `cluster-v6-calico_whereabouts.yaml` |    Calico   |    Calico    |      PTP      |   whereabouts  |
    | `cluster-v6-canal_hostlocal.yaml`    |    Canal    |     Canal    |      PTP      |   host-local   |
    | `cluster-v6-canal_whereabouts.yaml`  |    Canal    |     Canal    |      PTP      |   whereabouts  |
    | `cluster-v6-cilium_hostlocal.yaml`   |    Cilium   |    Cilium    |      PTP      |   host-local   |
    | `cluster-v6-cilium_whereabouts.yaml` |    Cilium   |    Cilium    |      PTP      |   whereabouts  |
